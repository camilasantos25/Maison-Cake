...
function Hero({ aoClicarEncomendar }) {
    return (
        <section id="inicio" className="bg-[#faf3ec] px-6 py-12 md:px-16 md:py-20 dark:bg-[#150e0a]">
            <div className='mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-12'>
                <div>
                    ...
                    <h1 className="mt-4 font-serif text-3xl font-bold leading-tight text-[#3d2418] dark:text-[#f4ebe1] md:text-5xl">
                        Bolos feitos para{' '}
                    ...
                    <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                        <a href='#bolos' className="cursor-pointer rounded-full bg-[#3d2418] px-6 py-3 text-center text-sm text-white transition-colors hover:bg-[#a05a3f]">
                            Ver nossos bolos
                        </a>
                ...
                <div className="relative">
                    <img
                        ...
                        className="h-[320px] w-full rounded-3xl object-cover md:h-[600px]"/>
